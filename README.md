...
The lobby variant replaces the dice-token meta with a configurable daily goal. Players progress the daily goal through paid-match wins and by reaching the 250-point secondary goal. The growing-pot model is the default, while the Admin screen can still switch between two reward models:
